...
$_config['db']['1']['dbuser'] = 'discuz-user';
$_config['db']['1']['dbpw'] = '@admin+Yh3yxyz#';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'YD9j_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '6ae762J79ivmtFZk';
